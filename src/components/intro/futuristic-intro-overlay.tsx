...
export default function FuturisticIntroOverlay({ onDismiss }: { onDismiss?: () => void }) {
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center overflow-y-auto bg-black/60 p-3 md:p-6">
      ...
      <motion.div
        ...
        className="relative my-auto w-full max-w-[min(94vw,420px)] md:w-[85%] md:max-w-6xl lg:w-[75%] rounded-2xl overflow-hidden shadow-2xl bg-white"
      >

      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-[800] text-[#0f172a] mb-8">
            IoT & AI <span className="bg-gradient-to-r from-[#2563eb] to-[#7c3aed] bg-clip-text text-transparent">Insights</span>
          </h2>
          </ScrollAnimation>

          <ScrollAnimation direction="up" delay={0.6}>
          <p className="text-xl md:text-2xl text-[#475569] max-w-4xl mx-auto leading-relaxed">
            Stay ahead with expert insights on <span className="text-[#2563eb] font-bold">IoT, AI and smart automation</span> technologies 
          ...
          <ScrollAnimation direction="up" delay={1.0}>
            <div className="mb-20">
              <div className="flex items-center mb-8">
                <Sparkles className="h-6 w-6 text-[#2563eb] mr-3" />
                <h2 className="text-3xl font-[800] text-[#0f172a]">Featured Articles</h2>
              </div>
              ...
              <ScrollStagger staggerDelay={0.15} childDelay={0.2}>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                  ...
                  <GlowEffect key={post.id} color="#6366f1" intensity={0}>
                    <Card className="group bg-white border border-slate-200 hover:border-[#2563eb]/30 transition-all duration-300 overflow-hidden h-full flex flex-col">
                      ...
                      <CardHeader className="space-y-4">
                        ...
                        <CardTitle className="text-2xl font-black text-[#0f172a] group-hover:text-[#2563eb] transition-colors line-clamp-2">
                          {post.title}
                        </CardTitle>
                      ...
                      <CardContent className="space-y-6 flex-1 flex flex-col">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="font-bold text-[#0f172a] text-sm">{post.author}</p>
              ...
              <ScrollStagger staggerDelay={0.1} childDelay={0.15}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  ...
                  <GlowEffect key={post.id} color="#8b5cf6" intensity={0}>
                    <Card className="group bg-white border border-slate-200 hover:border-[#2563eb]/30 transition-all duration-300 overflow-hidden h-full flex flex-col shadow-sm">
              ...
              <div className="glass backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-border/20 shadow-2xl max-w-4xl mx-auto">
                <div className="space-y-6">
                  <h3 className="text-3xl md:text-4xl font-[800] text-[#0f172a]">
                    Stay Updated with <span className="bg-gradient-to-r from-[#2563eb] to-[#7c3aed] bg-clip-text text-transparent">IoT Insights</span>
                  </h3>

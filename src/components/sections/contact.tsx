...
const features = [
  { icon: CheckCircle, text: "Free Consultation", color: "text-green-600", glowColor: "#10b981" },
  { icon: Shield, text: "Secure & Private", color: "text-blue-600", glowColor: "#3b82f6" },
  { icon: TrendingUp, text: "24/7 Support", color: "text-purple-600", glowColor: "#8b5cf6" },
  { icon: Users, text: "Expert Team", color: "text-orange-600", glowColor: "#f97316" },
];
 ...
 const onSubmit = async (data: ContactFormValues) => {
  ...
  return (
    <section className="relative section-padding gradient-secondary overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Enhanced Header */}
        <div id="get-in-touch" className="text-center mb-20">
          ...
          <ScrollAnimation direction="up" delay={0.6}>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Ready to transform your business with <span className="text-primary font-semibold">IoT solutions?</span> We&apos;re here to help you 
        ...
        <ScrollStagger staggerDelay={0.1} childDelay={0.8}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            {features.map((feature, index) => {
              ...
              return (
                <GlowEffect key={index} color={feature.glowColor} intensity={0}>
                  <div className="flex items-center space-x-3 p-4 glass backdrop-blur-sm rounded-2xl border border-border/20 hover:border-primary/30 transition-colors">
        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20">
          ...
          <div className="space-y-8">
            <ScrollAnimation direction="left" delay={0.4}>
              <div className="space-y-1">
                <h3 className="text-2xl md:text-3xl font-bold text-foreground">
                  <span className="bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">Multiple Ways</span> to Connect
                </h3>
            ...
            <ScrollAnimation direction="left" delay={1.0}>
              <GlowEffect color="#6366f1" intensity={0}>
                ...
                <div className="glass backdrop-blur-sm rounded-2xl p-4 border border-border/20">
          ...
          <ScrollAnimation direction="right" delay={0.6}>
            <GlowEffect color="#6366f1" intensity={0}>
              <div id="contact-form" className="glass backdrop-blur-xl rounded-3xl p-9  shadow-2xl border border-border/20">

          ...
          <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-24 lg:pb-28">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <ScrollAnimation direction="up" delay={0.4}>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-slate-100 mb-8 leading-tight">
                  IoT & AI <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Knowledge Hub</span>
                </h1>
              </ScrollAnimation>

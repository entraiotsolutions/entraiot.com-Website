              ...
              <div className="text-center mb-20">
                ...
                <ScrollAnimation direction="up" delay={0.4}>
                  <h1 className="text-5xl font-bold text-foreground mb-12">
                    IoT Hardware <span className="bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">Products</span>
                  </h1>
                </ScrollAnimation>
                
                <ScrollAnimation direction="up" delay={0.6}>
                  <p className="text-xl text-foreground/90 max-w-4xl mx-auto">
                    Complete range of <span className="text-primary font-semibold">UHF RFID readers, NFC modules and BLE devices</span>. Built for enterprise IoT applications. From industrial RFID readers to healthcare BLE devices. Our hardware meets the demanding requirements of modern IoT deployments.
                  </p>
                </ScrollAnimation>
              </div>
            </div>
        ...
        <section className="py-16 relative overflow-hidden gradient-accent">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 dark:from-slate-100 dark:via-blue-100 dark:to-indigo-100 bg-clip-text text-transparent mb-6 leading-tight">

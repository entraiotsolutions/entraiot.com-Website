...
export const metadata: Metadata = {
  title: "Smart City IoT Technology - Traffic Systems | Entraiot",
  description: "Build smarter cities with IoT solutions. Smart infrastructure, traffic management and environmental monitoring. Get started today.",
  keywords: ["smart cities", "urban IoT", "smart infrastructure", "traffic management", "environmental monitoring", "city planning"],
  alternates: {
    canonical: "https://entraiot.com/industries/smart-cities",
  },
  openGraph: {
    title: "Smart City IoT Technology - Traffic Systems | Entraiot",
    description: "Build smarter cities with IoT. Smart infrastructure, traffic management and environmental monitoring.",
    url: "https://entraiot.com/industries/smart-cities",
    images: [
      {
        url: "https://entraiot.com/RFID2.webp",
        width: 1200,
        height: 630,
        alt: "IoT Solutions for Smart Cities",
      },
    ],
  },
};
  ...
  const solutions = [
    {
      ...
      description: "Intelligent traffic systems with real-time monitoring and adaptive signal control.",
      benefits: ["30% traffic reduction", "Faster commute times", "Lower emissions"],
      icon: Building2
    },
    {
      title: "Environmental Monitoring",
      description: "Real-time air quality, noise and environmental data collection.",
      benefits: ["Public health insights", "Policy guidance", "Citizen awareness"],
      icon: MapPin
    },
    {
      title: "Smart Infrastructure",
      description: "Connected streetlights, smart parking and public facility management.",
      benefits: ["40% energy savings", "Improved safety", "Better utilization"],
      icon: Shield
    },
    {
      title: "Waste Management",
      description: "Optimized waste collection routes and smart bin monitoring.",
      benefits: ["25% cost reduction", "Cleaner cities", "Efficient operations"],
      icon: TrendingUp
    }
  ];

  const technologies = [
    "IoT Sensors", "LoRaWAN", "NFC Systems", "Cloud Platforms",
    "Data Analytics", "Mobile Apps", "Real-time Dashboards", "API Integration"
  ];
          ...
          <ScrollAnimation direction="up" delay={0.4}>
            <div className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-8 leading-tight">
                Urban <span className="bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">Smart City</span> Infrastructure
              </h1>
              
              <p className="text-xl text-muted-foreground leading-relaxed max-w-4xl">
                Transform urban living with smart IoT solutions. Improve infrastructure, enhance citizen services and create sustainable, connected communities.
              </p>
            </div>
          </ScrollAnimation>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-6 md:gap-8 text-center mt-6">
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">Traffic Reduction</div>
                      </div>
                      <div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8 space-y-8">
                <GlowEffect color="#6366f1" intensity={0}>
                  <Card className="glass backdrop-blur-sm border border-border/20">
                    <CardHeader>
                      <CardTitle className="text-lg">Ready to Build Smart Cities?</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <p className="text-sm text-muted-foreground">
                        Get a customized IoT solution for your city.
                      </p>
                      
                      <div className="space-y-3">
                        <CTAButton 
                          variant="primary" 
                          href="/contact/industry/smart-cities"
                          className="w-full"
                        >
                        ...
                        <CTAButton 
                          variant="demo" 
                          href="/contact/industry/smart-cities/demo"
                          className="w-full"
                        >
                          View Demo
                        </CTAButton>

...
export const metadata: Metadata = {
  title: "Healthcare IoT Systems - Patient Monitoring | Entraiot",
  description: "IoT solutions for healthcare. Patient monitoring, asset tracking and smart hospital management. Transform healthcare today.",
  keywords: ["healthcare IoT", "patient monitoring", "medical device tracking", "smart hospitals", "healthcare automation"],
  alternates: {
    canonical: "https://entraiot.com/industries/healthcare",
  },
  openGraph: {
    title: "Healthcare IoT Systems - Patient Monitoring | Entraiot",
    description: "IoT solutions for healthcare. Patient monitoring, asset tracking and smart hospital management.",
    url: "https://entraiot.com/industries/healthcare",
    images: [
      {
        url: "https://entraiot.com/NFC.webp",
        width: 1200,
        height: 630,
        alt: "IoT Solutions for Healthcare",
      },
    ],
  },
};
  ...
  const solutions = [
    {
      ...
      description: "Watch patient health all the time. Use IoT devices to manage long-term illnesses.",
      benefits: ["Reduced readmissions", "Better patient outcomes", "24/7 monitoring"],
      icon: Heart
    },
    {
      title: "Asset Tracking",
      description: "Track medical equipment, supplies, and medicine in real time.",
      benefits: ["50% time savings", "Reduced loss", "Improved inventory"],
      icon: Activity
    },
    {
      title: "Smart Environment Control",
      description: "Watch temperature, humidity, and air quality automatically.",
      benefits: ["Compliance assurance", "Energy optimization", "Patient comfort"],
      icon: Shield
    },
    {
      title: "Workflow Automation",
      description: "Make hospital work easier. Use smart automation to cut waste and save time.",
      benefits: ["30% efficiency gain", "Reduced errors", "Better resource use"],
      icon: TrendingUp
    }
  ];

  const technologies = [
    "BLE Devices", "NFC Systems", "Temperature Sensors", "Cloud Platforms",
    "HIPAA Compliance", "Mobile Apps", "Real-time Analytics", "Secure APIs"
  ];
          ...
          <ScrollAnimation direction="up" delay={0.4}>
            <div className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-8 leading-tight">
                Smart <span className="bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">Healthcare</span> Technology Solutions
              </h1>
              
              <p className="text-xl text-muted-foreground leading-relaxed max-w-4xl">
                Improve patient care and optimize operations. Ensure compliance. We design smart IoT solutions specifically for healthcare facilities.
              </p>
            </div>
          </ScrollAnimation>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8 space-y-8">
                <GlowEffect color="#6366f1" intensity={0}>
                  <Card className="glass backdrop-blur-sm border border-border/20">
                    <CardHeader>
                      <CardTitle className="text-lg">Ready to Transform Healthcare?</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <p className="text-sm text-muted-foreground">
                        Get a customized IoT solution for your healthcare facility.
                      </p>
                      ...
                      <div className="space-y-3">
                        ...
                        <CTAButton 
                          variant="demo" 
                          href="/contact/industry/healthcare/demo"
                          className="w-full"
                        >
                          View Demo
                        </CTAButton>

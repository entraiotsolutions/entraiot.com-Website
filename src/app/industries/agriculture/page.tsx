...
export const metadata: Metadata = {
  title: "Agricultural IoT Technology - Smart Farming | Entraiot",
  description: "Precision farming with IoT solutions. Yield optimization, water conservation and soil health monitoring. Get started today.",
  keywords: ["agriculture IoT", "precision farming", "smart agriculture", "crop monitoring", "irrigation automation", "soil sensors"],
  alternates: {
    canonical: "https://entraiot.com/industries/agriculture",
  },
  openGraph: {
    title: "Agricultural IoT Technology - Smart Farming | Entraiot",
    description: "Precision farming with IoT. Yield optimization, water conservation and soil health monitoring.",
    url: "https://entraiot.com/industries/agriculture",
    images: [
      {
  ...
  const solutions = [
    {
      ...
      description: "Automated irrigation systems based on soil moisture and weather conditions.",
      benefits: ["40% water savings", "Optimal irrigation", "Cost reduction"],
      icon: Droplets
    },
    {
      title: "Soil Health Monitoring",
      description: "Real-time soil sensors for nutrients, pH and moisture levels.",
      benefits: ["Better crop health", "Yield optimization", "Resource efficiency"],
      icon: Leaf
    },
    {
      title: "Crop Monitoring",
      description: "IoT sensors and drones for crop growth, health and yield prediction.",
      benefits: ["Early problem detection", "Yield prediction", "Quality improvement"],
      icon: Shield
    },
    {
      title: "Precision Farming",
      description: "Data-driven farming decisions with AI-powered analytics and automation.",
      benefits: ["25% yield increase", "Reduced waste", "Better ROI"],
      icon: TrendingUp
    }
  ];

  const technologies = [
    "Soil Sensors", "Weather Stations", "IoT Drones", "Automated Irrigation",
    "Cloud Analytics", "AI/ML Models", "Mobile Apps", "Real-time Dashboards"
  ];
          ...
          <ScrollAnimation direction="up" delay={0.4}>
            <div className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-8 leading-tight">
                Precision <span className="bg-gradient-to-r from-primary to-emerald-600 bg-clip-text text-transparent">Agriculture</span> Solutions
              </h1>
              
              <p className="text-xl text-muted-foreground leading-relaxed max-w-4xl">
                Boost yield and conserve resources. Optimize operations. We design smart IoT solutions for modern agriculture.
              </p>
            </div>
          </ScrollAnimation>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8 space-y-8">
                <GlowEffect color="#6366f1" intensity={0}>
                  <Card className="glass backdrop-blur-sm border border-border/20">
                    <CardHeader>
                      <CardTitle className="text-lg">Ready to Transform Agriculture?</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <p className="text-sm text-muted-foreground">
                        Get a customized IoT solution for your farming operations.
                      </p>
                      
                      <div className="space-y-3">
                        <CTAButton 
                          variant="primary" 
                          href="/contact/industry/agriculture"
                          className="w-full"
                        >
                        ...
                        <CTAButton 
                          variant="demo" 
                          href="/contact/industry/agriculture/demo"
                          className="w-full"
                        >
                          View Demo
                        </CTAButton>
